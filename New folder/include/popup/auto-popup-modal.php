          ...
          <div class="col-12 col-md-5 order-1 order-md-0">
            <div class="left-image-panel h-100 d-flex flex-column justify-content-between text-white p-4">
              <picture>
                ...
                <source srcset="sandbox:/mnt/data/deb1ef5d-9811-4e02-ad7b-4a7da0e750d6.png" type="image/png" />
                <img src="sandbox:/mnt/data/deb1ef5d-9811-4e02-ad7b-4a7da0e750d6.png"
              ...
              <div class="mt-3 small text-white-50">
                Trusted by industry • Hands-on labs • NASSCOM & Microsoft aligned
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-md-7 order-0 order-md-1">
            <div class="right-panel p-4 d-flex flex-column h-100">
              ...
              <div id="cehViewCTA" class="view-cta">
                <h3 class="text-primary fw-bold mb-2">ENROLL NOW</h3>
                ...
                <div class="d-grid gap-2" style="max-width:420px;">
                  ...
                  <a href="tel:+919876543210" class="btn btn-outline-secondary">
                    <i class="fa-solid fa-phone me-2" aria-hidden="true"></i> Call +91 98765 43210
                  </a>
                </div>
                ...
                <ul class="list-unstyled mt-4 small text-muted">
                  ...
                  <li>• Course aligned with CEH v13 AI curriculum</li>
                </ul>
              </div>
              ...
              <div id="cehViewForm" class="view-form" style="display:none;">
                ...
                <div class="mt-3 small text-muted">Or use the original form below if you prefer:</div>
                ...
                <div class="ratio ratio-4x3 mt-2" style="max-width:100%;">
                  <iframe id="cehLeadIframe"
                          src="https://center.webasha.com/forms/wtl/38abc0c48e3ee81958804487d34cf62f"
...
<style>
  .left-image-panel { background:#0c4a9a; min-height:360px; position:relative; }
